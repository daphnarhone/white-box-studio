...
export const SERVICES = [
  {
    ...
    he: {
      ...
      applications: ['קירות נושאי עניין ופינות כניסה', 'סלונים וחללי מגורים', 'מסעדות, ברים ובתי קפה', 'חנויות בוטיק וחללי מסחר', 'לובי וקבלה במלונות', 'משטחי חוץ וחזיתות נבחרים'],
      ...
      steps: [
        ...
        { t: 'ביצוע באתר', b: 'הטיח מיושם ידנית, ישירות על הקיר, בקנה מידה ובקצב המתאימים לו.' }
      ],
    ...
    en: {
      ...
      steps: [
        ...
        { t: 'Define the direction', b: 'We choose texture, colour, and finish language, and plan the application approach.' },
...

  {
    ...
    he: {
      ...
      images: [
        ...
        { src: '/assets/images/02_tables_2.jpeg', alt: 'שולחן קפה כחול אירידיסנטי מעוצב עם פולי קפה' }
      ],
    ...
    en: {
      ...
      eyebrow: '02 / Sculptural coffee tables',
...

  {
    ...
    he: {
      ...
      ctaHero: 'הזמינו פסל',
      images: [
        { src: '/assets/images/03_sculpture_2.jpeg', alt: 'ראש אריה פיסולי גדול' },
      ...
      applications: ['בתים פרטיים', 'חללי אירוח ומלונות', 'חללי מסחר וחנויות', 'פינות כניסה וקירות מוקד', 'חללים ממותגים או מבוססי-אירוע'],
      ...
      steps: [
        ...
        { t: 'יצירה והתקנה', b: 'מפסלים, מגמרים ומתכננים את ההתקנה.' }
      ],
      faqTitle: 'שאלות נפוצות',
      faq: [
...

  {
    ...
    he: {
      ...
      applications: ['תקרות מוקד', 'קירות הצהרה', 'חללי כניסה', 'חללי אירוח ומלונות', 'פרויקטים למגורים', 'חדרי אוכל ולובי'],
...

  {
    ...
    he: {
      ...
      serviceType: 'אביזרי תצוגה ומתנה', crumb: 'אביזרי תצוגה ומתנה',
      eyebrow: '05 / אביזרי תצוגה, אירועים ומתנה',
      h1: 'אובייקטים בקנה מידה קטן שנושאים את כל האווירה',
      ...
      images: [
        { src: '/assets/images/05_display_1.jpg', alt: 'סטנדים אומנותיים מוזהבים לתצוגה' },
        { src: '/assets/images/05_display_2.jpg', alt: 'סיכות ומסרקות שיער מוזהבים בעבודת יד' }
      ],
      ...
      processTitle: 'תהליך העבודה',
      steps: [
        { t: 'מטרת הפריט', b: 'מבינים את התכלית ואת האווירה שצריך ליצור.' },
        { t: 'הגדרת כיוון', b: 'מגדירים הפניות, צורה ושפת חומר.' },
    ...
    en: {
      ...
      eyebrow: '05 / Display, event & gift accessories',
      ...
      images: [
        { src: '/assets/images/05_display_1.jpg', alt: 'Gold artisan display stands' },
        { src: '/assets/images/05_display_2.jpg', alt: 'Hand-made artisan gold hair pins and combs' }
      ],
...

  {
    ...
    he: {
      ...
      applications: ['דלתות ודלתות כניסה', 'קירות מוקד', 'רגעי כניסה', 'חללי מסחר', 'חללי אירוח ומלונות', 'פרטי ריהוט ואדריכלות נבחרים'],
      finishesTitle: 'כיווני גימור',
      ...
      faq: [
        ...
        { q: 'אפשר לכוונן את הגוון?', a: 'כן, מעדין ועד דרמטי.' },
...

  {
    ...
    he: {
      ...
      applicationsTitle: 'יישומים',
      applications: ['תקרות ועמודים', 'כניסות', 'פרטי מסגור', 'קומפוזיציות קיר', 'חזיתות מסחריות', 'אזורי מוקד'],
      finishesTitle: 'כיווני עיצוב',
      ...
      steps: [
        ...
        { t: 'הגדרת רמת הפרט', b: 'קובעים את רמת הקישוט והמיקום.' },
        { t: 'פיתוח והכנה', b: 'מפתחים את האלמנטים ומכינים להתקנה.' }
      ],
      faqTitle: 'שאלות נפוצות',
      faq: [
        { q: 'אפשר פרט עיטורי מעדין ועד עשיר?', a: 'כן.' },
        { q: 'אלה יכולים לעבוד כאקצנטים עצמאיים?', a: 'כן, או כחלק מקומפוזיציה רחבה.' },
        { q: 'אתם עובדים עם עלה זהב?', a: 'כן.' },
        { q: 'איך מתחילים?', a: 'משתפים הפניות ופרטי חלל.' },
        { q: 'אתם עובדים רק בישראל?', a: 'כן, נכון לעכשיו.' }
      ],
      bandH2: 'צריך פרט דקורטיבי עם אלגנטיות, דיוק ואופי?',
...

  {
    ...
    he: {
      ...
      applicationsTitle: 'איפה ציורי קיר עובדים',
      applications: ['קירות מוקד', 'מסעדות וברים', 'חדרי ילדים', 'חנויות בוטיק', 'חללי אירוח', 'חדרי מדרגות, כניסות וחללים ממותגים'],
      finishesTitle: 'כיווני עיצוב',
      ...
      faq: [
        ...
        { q: 'אפשר מעדין ועד אקספרסיבי?', a: 'כן.' },
...

  {
    ...
    he: {
      ...
      applicationsTitle: 'יישומים',
      applications: ['קירות מוקד וקירות הצהרה', 'חללי מסחר ואירוח', 'חללי מגורים מודרניים', 'אובייקטים פיסוליים-שימושיים', 'פאנלי קיר ומשטחים', 'פרטי אדריכלות'],
      finishesTitle: 'כיווני גימור',
      ...
      steps: [
        ...
        { t: 'ביצוע בעבודת יד', b: 'יוצרים ומגמרים את העבודה ידנית.' }
      ],
      faqTitle: 'שאלות נפוצות',
      faq: [
      ...
      bandH2: 'רוצים חומר גולמי ומעודן שנקרא כמכוון ומלאכת-יד?',
